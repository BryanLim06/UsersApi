package com.bryanlim.userscrudproject.adapter;
...
import com.bryanlim.userscrudproject.EditActivity;
import com.bryanlim.userscrudproject.MainActivity;
import com.bryanlim.userscrudproject.R;
...
public class UserAdapter  extends RecyclerView.Adapter<UserAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView){
            ...
            mImageViewAvatar = (ImageView)itemView.findViewById(R.id.tvAvatar);
        }
    }
}